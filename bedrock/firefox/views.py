...
class WhatsNewFranceView(WhatsnewView):
    def get_template_names(self):
        template = super().get_template_names()
        locale = l10n_utils.get_locale(self.request)
        if switch('firefox-whatsnew-92-vpn-pricing') and template == ['firefox/whatsnew/whatsnew-fx92-en.html'] and locale.startswith('en-'):
            template = ['firefox/whatsnew/whatsnew-fx92-vpn-en.html']
        elif switch('firefox-whatsnew-92-vpn-pricing') and locale == 'fr':
